...
Simplified API: Abstracts zkVM complexity – agents receive verifiable receipts hiding strategy details.
Universal Order Intents: Schema for multi-venue, privacy-first trades with advanced specs.
x402 Integration: Agents pay per prove() in USDC for seamless, accountless micropayments.
Framework Hooks: Native SDK for OpenClaw and MCP, enabling one-line verifiable tool calls.
Fork the repo and follow me on twitter to stay updated, shouldn't be too long ;)
