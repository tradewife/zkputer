...
## Active Setups
1. **Momentum Catalyst (HYPE)**
   - Status: Active
   - Win Rate: 1/1 (Last trade +$3.50)
   - Focus: HYPE-USD ($33.40) - Merger Catalyst
   - Thesis: Merger with Sonnet + Nasdaq listing. Buy dips to $32.80.

2. **Flow/Range (BTC)**
   - Status: Watchlist
   - Win Rate: N/A
   - Focus: BTC-USD ($88.5k)
   - Thesis: Consolidating, look for support bounce.

3. **Funding Arbitrage**
   - Status: Monitoring
   - Note: AVAX funding -0.0055% (Low but negative).

4. **Smart Money Follow**
   - Status: Active
   - Win Rate: 0/1
   - Current Plays: Monitoring Whale Intel (Dextrabot).
