...
class TradingConfig:
    ...
    @classmethod
    def from_file(cls, config_path: str = "/home/kt/ZKputer/ExtendOPS/config/trading_config.json"):
...
def create_sample_config():
    ...
    os.makedirs("/home/kt/ZKputer/ExtendOPS/config", exist_ok=True)
    with open("/home/kt/ZKputer/ExtendOPS/config/trading_config.json.example", "w") as f:
